...
export default function WodDoDia() {
  ...
  // Pré-preenche com o resultado já postado
  useEffect(() => {
    ...
    <div className="min-h-screen bg-background pb-32">
      ...
      <header className="p-6 pt-12 flex flex-col gap-4">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-headline font-black italic text-on-surface uppercase tracking-tight">WOD do Dia</h1>
            <p className="text-on-surface-variant text-xs font-medium uppercase tracking-widest opacity-60 flex items-center gap-1">
      ...
      <main className="px-6 flex flex-col gap-3">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-headline font-black text-sm text-on-surface uppercase italic tracking-widest">
        ...
        {loading ? (
          ...
          <div className="bg-surface-container rounded-3xl p-12 flex flex-col items-center text-center gap-3 border border-outline-variant/10">
            <Trophy className="w-14 h-14 text-on-surface-variant/20" />
